...
namespace MastaneClinic.Controllers
{
    ...
    public class ServicesController : Controller
    {
        ...
        { 
            ...
            {
                Service = service,
                SidebarServices = db.Services.Where(c=>c.IsDeleted==false&&c.Id!=service.Id&&c.IsActive).OrderBy(c=>c.Order).ToList(),
                SidebarBlog = GetSidebarBlogBySericeId(service.Id)
            };
